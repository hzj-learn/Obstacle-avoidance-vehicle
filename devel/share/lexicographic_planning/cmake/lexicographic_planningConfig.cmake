...
if(lexicographic_planning_CONFIG_INCLUDED)
  return()
endif()
set(lexicographic_planning_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(lexicographic_planning_SOURCE_PREFIX /home/hzj/r150-lidar-obstacle-avoidance-master/src/planning/local/lexicographic_planning)
  set(lexicographic_planning_DEVEL_PREFIX /home/hzj/r150-lidar-obstacle-avoidance-master/devel)
  set(lexicographic_planning_INSTALL_PREFIX "")
  set(lexicographic_planning_PREFIX ${lexicographic_planning_DEVEL_PREFIX})
else()
  set(lexicographic_planning_SOURCE_PREFIX "")
  set(lexicographic_planning_DEVEL_PREFIX "")
  set(lexicographic_planning_INSTALL_PREFIX /home/hzj/r150-lidar-obstacle-avoidance-master/install)
  set(lexicographic_planning_PREFIX ${lexicographic_planning_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'lexicographic_planning' is deprecated")
...
set(lexicographic_planning_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/hzj/r150-lidar-obstacle-avoidance-master/src/planning/local/lexicographic_planning/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(lexicographic_planning_INCLUDE_DIRS "")
  set(_include_dirs "/home/hzj/r150-lidar-obstacle-avoidance-master/src/planning/local/lexicographic_planning/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${lexicographic_planning_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lexicographic_planning' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'lexicographic_planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hzj/r150-lidar-obstacle-avoidance-master/src/planning/local/lexicographic_planning/${idir}'.  ${_report}")
    endif()
    _list_append_unique(lexicographic_planning_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND lexicographic_planning_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND lexicographic_planning_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT lexicographic_planning_NUM_DUMMY_TARGETS)
      set(lexicographic_planning_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lexicographic_planning::wrapped-linker-option${lexicographic_planning_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lexicographic_planning_NUM_DUMMY_TARGETS "${lexicographic_planning_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lexicographic_planning::wrapped-linker-option${lexicographic_planning_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lexicographic_planning_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hzj/r150-lidar-obstacle-avoidance-master/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(lexicographic_planning_LIBRARY_DIRS ${lib_path})
      list(APPEND lexicographic_planning_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'lexicographic_planning'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND lexicographic_planning_LIBRARIES ${lib})
    endif()
  endif()
...
set(lexicographic_planning_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${lexicographic_planning_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "geometry_msgs;std_msgs;nav_msgs;visualization_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 lexicographic_planning_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${lexicographic_planning_dep}_FOUND)
      find_package(${lexicographic_planning_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lexicographic_planning_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(lexicographic_planning_INCLUDE_DIRS ${${lexicographic_planning_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(lexicographic_planning_LIBRARIES ${lexicographic_planning_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${lexicographic_planning_dep}_LIBRARIES})
  _list_append_deduplicate(lexicographic_planning_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(lexicographic_planning_LIBRARIES ${lexicographic_planning_LIBRARIES})

  _list_append_unique(lexicographic_planning_LIBRARY_DIRS ${${lexicographic_planning_dep}_LIBRARY_DIRS})
  list(APPEND lexicographic_planning_EXPORTED_TARGETS ${${lexicographic_planning_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${lexicographic_planning_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
