...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_saver_SOURCE_PREFIX /home/hzj/r150-lidar-obstacle-avoidance-master/src/planning/global/waypoints_manager/waypoint_saver)
  set(waypoint_saver_DEVEL_PREFIX /home/hzj/r150-lidar-obstacle-avoidance-master/devel)
  ...
  set(waypoint_saver_INSTALL_PREFIX /home/hzj/r150-lidar-obstacle-avoidance-master/install)
...
if(NOT "/home/hzj/r150-lidar-obstacle-avoidance-master/src/planning/global/waypoints_manager/waypoint_saver/include " STREQUAL " ")
  set(waypoint_saver_INCLUDE_DIRS "")
  set(_include_dirs "/home/hzj/r150-lidar-obstacle-avoidance-master/src/planning/global/waypoints_manager/waypoint_saver/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_saver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hzj/r150-lidar-obstacle-avoidance-master/src/planning/global/waypoints_manager/waypoint_saver/${idir}'.  ${_report}")
    endif()
    _list_append_unique(waypoint_saver_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "waypoint_saver")
...
set(depends "geometry_msgs;roscpp;tf;nav_msgs")
foreach(depend ${depends})
  ...
  list(APPEND waypoint_saver_EXPORTED_TARGETS ${${waypoint_saver_dep}_EXPORTED_TARGETS})
endforeach()
