...
if(r150_ndt_localizer_CONFIG_INCLUDED)
  return()
endif()
set(r150_ndt_localizer_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(r150_ndt_localizer_SOURCE_PREFIX /home/hzj/r150-lidar-obstacle-avoidance-master/src/localization/r150_ndt_localizer)
  set(r150_ndt_localizer_DEVEL_PREFIX /home/hzj/r150-lidar-obstacle-avoidance-master/devel)
  set(r150_ndt_localizer_INSTALL_PREFIX "")
  set(r150_ndt_localizer_PREFIX ${r150_ndt_localizer_DEVEL_PREFIX})
else()
  set(r150_ndt_localizer_SOURCE_PREFIX "")
  set(r150_ndt_localizer_DEVEL_PREFIX "")
  set(r150_ndt_localizer_INSTALL_PREFIX /home/hzj/r150-lidar-obstacle-avoidance-master/install)
  set(r150_ndt_localizer_PREFIX ${r150_ndt_localizer_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'r150_ndt_localizer' is deprecated")
...
if(NOT "/home/hzj/r150-lidar-obstacle-avoidance-master/devel/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'sasaki <r150@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${r150_ndt_localizer_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'r150_ndt_localizer' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'r150_ndt_localizer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hzj/r150-lidar-obstacle-avoidance-master/src/localization/r150_ndt_localizer/${idir}'.  ${_report}")
    endif()
    _list_append_unique(r150_ndt_localizer_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND r150_ndt_localizer_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND r150_ndt_localizer_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT r150_ndt_localizer_NUM_DUMMY_TARGETS)
      set(r150_ndt_localizer_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::r150_ndt_localizer::wrapped-linker-option${r150_ndt_localizer_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR r150_ndt_localizer_NUM_DUMMY_TARGETS "${r150_ndt_localizer_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::r150_ndt_localizer::wrapped-linker-option${r150_ndt_localizer_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND r150_ndt_localizer_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(r150_ndt_localizer_LIBRARY_DIRS ${lib_path})
      list(APPEND r150_ndt_localizer_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'r150_ndt_localizer'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND r150_ndt_localizer_LIBRARIES ${lib})
    endif()
  endif()
...
set(r150_ndt_localizer_EXPORTED_TARGETS "r150_ndt_localizer_generate_messages_cpp;r150_ndt_localizer_generate_messages_eus;r150_ndt_localizer_generate_messages_lisp;r150_ndt_localizer_generate_messages_nodejs;r150_ndt_localizer_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${r150_ndt_localizer_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 r150_ndt_localizer_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${r150_ndt_localizer_dep}_FOUND)
      find_package(${r150_ndt_localizer_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${r150_ndt_localizer_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(r150_ndt_localizer_INCLUDE_DIRS ${${r150_ndt_localizer_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(r150_ndt_localizer_LIBRARIES ${r150_ndt_localizer_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${r150_ndt_localizer_dep}_LIBRARIES})
  _list_append_deduplicate(r150_ndt_localizer_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(r150_ndt_localizer_LIBRARIES ${r150_ndt_localizer_LIBRARIES})

  _list_append_unique(r150_ndt_localizer_LIBRARY_DIRS ${${r150_ndt_localizer_dep}_LIBRARY_DIRS})
  list(APPEND r150_ndt_localizer_EXPORTED_TARGETS ${${r150_ndt_localizer_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "r150_ndt_localizer-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${r150_ndt_localizer_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
